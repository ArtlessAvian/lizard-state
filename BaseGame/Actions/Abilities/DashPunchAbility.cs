...
public class DashPunchAbility : CrawlAction
{
    public override bool Do(Model model, Entity e)
    {
        ...
        if (target != null)
        {
            ReachAttackAction thing = GD.Load<ReachAttackAction>("res://BaseGame/Attacks/ReachAttacks/HellaKnockback.tres");
            CrawlAction subaction = GD.Load<CSharpScript>("res://BaseGame/Actions/ReachAttackFollowup.cs").New(thing) as CrawlAction;
