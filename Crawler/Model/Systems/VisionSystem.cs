// TODO: Split VisionSystem off of Map (which should just be a data container).
...
// /// <summary>
// /// Systems are called every now and then.
// /// This one manages entity vision and stores vision history.
// /// </summary>
...
//     public TileMap fog; // creates orphan nodes >:/
...
//     public bool[,] GetVisibleTiles((int x, int y) pos, int radius = 6)
//     {
//         ClearVisibility();
//         UpdateVisibility(pos, radius);

//         bool[,] tiles = new bool[radius * 2 + 1, radius * 2 + 1];
...
//             if (Map.TileIsWall(map.map.GetCell(x, y)))
//             {
//                 return;
//             }
//         }
